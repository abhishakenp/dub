...
> = {
  ...
  razorpay: {
    ...
    processing:
      "Payouts that are being processed by the program – this can take up to 5 business days.",
    processed:
      "Payouts that have been processed by the program and will be paid out to your bank account or UPI via Razorpay.",
    sent: "Payouts that are on their way to your bank account or UPI – typically arriving within minutes to a few hours.",
    completed:
      "Payouts that have been paid out to your bank account or UPI.",
  },
};
